 ...
 * Generated at: 2019-08-26 07:15:28 UTC
...
public final class item_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function(){    \r\n");
      out.write("\t$(\"#contentCategory\").tree({    //通过ID选择器创建一个树\r\n");
      out.write("\t\turl : '/item/cat/list',\t\t//跳转到后台的路径\r\n");
      out.write("\t\tanimate: true,\t\t\t\t\r\n");
      out.write("\t\tmethod : \"GET\",\t\t\t\t//方法是get请求\r\n");
      ...
      out.write("        \t\t// 新增节点\r\n");
      out.write("        \t\t$.post(\"/item/cat/create\",{parentId:node.parentId,name:node.text},function(data){\r\n");
      out.write("        \t\t\tif(data.status == 200){   //状态码=200，就是成功的\r\n");
      ...
      out.write("        \t}else{\r\n");
      out.write("        \t\t//更新节点\r\n");
      out.write("        \t\t$.post(\"/item/cat/update\",{id:node.id,name:node.text});\r\n");
      out.write("        \t}\r\n");
      out.write("        }\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      ...
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t$.post(\"/item/cat/delete\",{parentId:node.parentId,id:node.id},function(data){\r\n");
      out.write("\t\t\t\t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t\t\ttree.tree(\"remove\",node.target);\r\n");
      out.write("        \t\t\t}else{\r\n");
      out.write("        \t\t\t\t$.messager.alert('提示','目录下有子目录或者商品，导致删除失败！');\r\n");
      out.write("        \t\t\t}\r\n");
      out.write("\t\t\t\t});\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
