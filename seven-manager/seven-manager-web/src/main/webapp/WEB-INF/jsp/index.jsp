    	...
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		...
         		<ul>
	         		...
	         		<li data-options="attributes:{'url':'item-list'}">图书列表</li>
         	...
         	<li>
         		<span>类别管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'item-category'}">图书类别管理</li>
	         		<li data-options="attributes:{'url':'item-category-content'}">类目图书管理</li>
	         	</ul>
         	</li>
         	<li>
         		<span>订单管理</span>
